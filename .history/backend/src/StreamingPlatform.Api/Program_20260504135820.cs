...
builder.Services.AddDbContext<AppDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("Host=aws-0-eu-west-1.pooler.supabase.com;Database=postgres;Username=postgres.nnetlrrjtodlxdoohkmo;Password=adekolze_6427;SSL Mode=Require;Trust Server Certificate=true"),
